...
use Vainyl\Http\Proxy\RequestProxyInterface;
 ...
 */
class PhalconRequestStack extends AbstractServerRequestDecorator implements PhalconRequestInterface, RequestProxyInterface
{
    /**
     * @inheritDoc
     */
